...
public record PhoneNumberDTO(
        ...
        @NotNull @Size(message = "Phone number must be 4-15 digits", min = 4, max = 15) @Pattern(message = "Phone number must contain digits only", regexp = "\\d+") @NotEmpty @NotBlank(message = "Phone number is required") String number) implements Serializable {
}